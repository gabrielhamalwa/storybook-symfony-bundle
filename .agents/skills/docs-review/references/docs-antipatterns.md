...
**Recognize it:** A bundle-specific term (e.g., "adapter", "entrypoint", "asset pipeline") appears in the opening paragraphs but is not defined or linked until later.
...
## 9. Overexplaining Basics While Underexplaining Bundle-Specific Behavior

**Problem:** The page spends space on concepts the target audience already knows (e.g., what a component is, how autoloading works) while glossing over bundle-specific behavior that is actually confusing.

**Recognize it:** Paragraphs explaining general PHP or Symfony concepts sit alongside one-sentence descriptions of bundle features that have no obvious analog.

**Fix:** Assume basic PHP, Symfony, and web development knowledge. Invest explanation space in bundle-specific concepts, behaviors, and mental models.
