...
Bundle docs must work for two audiences simultaneously:

1. **PHP/Symfony developers** scanning for answers, examples, and steps they can act on immediately.
...
The page assumes the right level of prior knowledge. It does not over-explain PHP or Symfony fundamentals or under-explain bundle-specific behavior. It meets the reader where they are.
